    ...
    <div className="flex flex-col h-full bg-gray-900">
      ...
      <div className="relative flex-1 min-h-0 overflow-hidden">
        ...
        {imageryUrl ? (
          ...
          <div className="w-full h-full flex flex-col items-center justify-center relative bg-[#0d1117]">
            ...
            <svg viewBox="0 0 320 240" className="w-full max-w-[340px] opacity-30 relative z-10" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {(imagerySource ?? imageryUrl) && (
          <div className="absolute top-3 right-3 z-20 flex flex-col items-end gap-0.5">
            {imagerySource && (
              <span className="text-[9px] font-medium text-gray-400 bg-gray-950/70 px-2 py-0.5 rounded">
                {imagerySource}
              </span>
            )}
            {imageryDate && (
              <span className="text-[9px] text-gray-600 bg-gray-950/60 px-2 py-0.5 rounded">
                {imageryDate}
              </span>
            )}
          </div>
      ...
      <div className="border-t border-gray-800 px-5 py-4">
        ...
        <div className="grid grid-cols-2 gap-x-6 gap-y-4">
          <div>
            <span className="text-[9px] font-semibold uppercase tracking-widest text-gray-500 block mb-0.5">CV Confidence</span>
            <span className={`text-lg font-black leading-none ${cvColor}`}>{cvConfidencePct}%</span>
            <span className="text-[9px] text-gray-600 block mt-0.5">Satellite detection</span>
          </div>
          <div>
            <span className="text-[9px] font-semibold uppercase tracking-widest text-gray-500 block mb-0.5">Urgency Score</span>
